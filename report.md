...
* [Ошибка в коде валидации номера карты с 19-ю символами](https://github.com/Stacyde/-Credit-Card-Number-Validator-17/issues/1)
* [Ошибка в коде валидации номеров карт с 14-ю символами](https://github.com/Stacyde/-Credit-Card-Number-Validator-17/issues/2)
* [Ошибка в коде валидации номеров карт с 15-ю символами](https://github.com/Stacyde/-Credit-Card-Number-Validator-17/issues/3)

## Описание процесса тестирования

В процессе тестирования использовались следующие артефакты:
* [Фейковые номера банковский карт](https://www.freeformatter.com/credit-card-number-generator-validator.html)
* [Код валидации номера банковской карты](https://github.com/netology-code/javaqa-homeworks/tree/master/intro)

В качестве тестовых данных использовались данные: [Фейковые номера банковских карт](https://www.freeformatter.com/credit-card-number-generator-validator.html)
